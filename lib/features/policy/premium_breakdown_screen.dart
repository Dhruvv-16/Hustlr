        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text('Fixed for 91 days (quarterly) · Next review in 3 months', style: TextStyle(color: isDark ? theme.colorScheme.onSurface.withOpacity(0.6) : theme.colorScheme.onPrimary.withOpacity(0.8), fontSize: 12, fontWeight: FontWeight.w600)),
            ],
          ),
        ],
      ),
    ...
    return _SurfaceCard(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('(2.0× base plan rate)', style: TextStyle(fontSize: 11, color: theme.colorScheme.onSurface.withOpacity(0.4), fontWeight: FontWeight.w600)),
          const SizedBox(height: 16),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
          ...
          Text('(0.7× base plan rate)', style: TextStyle(fontSize: 11, color: theme.colorScheme.onSurface.withOpacity(0.4), fontWeight: FontWeight.w600)),
          const SizedBox(height: 20),
