// services/demo_disruption_control.js
...
const { getCurrentWeather, get7DayForecast } = require('./weather_service');
const { getCurrentAQI, assessAQIDisruption } = require('./aqi_service');
const { checkBandhNLP } = require('./news_service');
const { getPlatformStatus, detectPlatformTrigger } = require('./platform_service');
