...
CHENNAI_SPECIAL_PRIORS: List[Tuple[str, float]] = [
    ...
    ("kathankulathur dark store zone", 0.56),
    ("kattankulathur dark store zone", 0.56),
    ("guduvanchery dark store zone", 0.57),
    ("urapakkam dark store zone", 0.57),
    ("potheri dark store zone", 0.56),
    ("kelambakkam dark store zone", 0.69),
    ("siruseri dark store zone", 0.69),
]
...
CHENNAI_NLP_RULE_ZONE_HINTS: List[str] = [
    ...
    "kattankulathur",
    "potheri",
    "kathankulathur dark store zone",
    "kattankulathur dark store zone",
    "guduvanchery dark store zone",
    "urapakkam dark store zone",
    "potheri dark store zone",
    "kelambakkam dark store zone",
    "siruseri dark store zone",
    "perungalathur",
    "selaiyur",
    "kelambakkam",
    "siruseri",
