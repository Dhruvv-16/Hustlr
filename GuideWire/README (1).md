...
India has **7.7 million** gig delivery workers earning ₹4,000–₹6,000 per week with no paid leave, no sick days, and no safety net. Chennai alone sees **~80 rain days per year.** On a heavy rain day, a rider loses ₹400–₹600. Cyclone Michaung wiped out 3–4 days of income per worker with no recourse. A sudden accident blockspot, internet zone blackout, or platform crash can kill an entire evening's earnings with zero compensation.
...
| Dark Store / Hub Shutdown | Photo of closed hub + Zomato/Blinkit screenshot | Platform API + NLP scraper | 4 hrs |
...
Dark Store / Hub Closed  1 photo of closed hub entrance
                         + Zomato/Blinkit screenshot showing no orders
...
India's gig workers are uniquely vulnerable to localized internet outages — tower outages, ISP maintenance, and government-ordered shutdowns routinely affect specific pin codes for hours. A Zomato delivery partner cannot accept orders, navigate, or scan QR codes during a connectivity blackout. This is a direct, quantifiable income loss with no existing insurance coverage.
...
A platform outage affects one app (Zomato). An internet blackout simultaneously kills every platform — Zomato, Swiggy, Google Maps, UPI payments. Hustlr's Internet Blackout trigger is platform-agnostic and fires when the worker's entire operating environment goes dark, not just one app.
...
```
Date:       March 15, 2026 — Dinner rush, 8:30 PM
...
SIGNAL_WEIGHTS = {
    ...
    'platform_app_inactive':       15,   # Not logged into Zomato/Swiggy during event
